...
1. Zakres analizy
Synoptyk v2 przetwarza dane wsteczne z ECMWF i ICON, normalizuje je do wspólnej siatki oraz wylicza:
...
Na tej podstawie generuje 14‑dniowy raport trendowy, bez potrzeby pobierania prognoz przyszłych.
